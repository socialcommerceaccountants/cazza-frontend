...
export default function IntegrationDashboard() {
  const [integrations, setIntegrations] = useState<IntegrationStatus[]>([
    ...
    },
    {
      ...
      syncUrl: '/api/integrations/quickbooks/sync',
    },
    {
      id: 'woocommerce',
      name: 'WooCommerce',
      ...
      color: 'bg-orange-500',
      configUrl: '/integrations/woocommerce',
    ...
    },
    {
      ...
      icon: <CreditCard className="h-5 w-5" />,
      color: 'bg-purple-500',
      configUrl: '/integrations/billing',
      disconnectUrl: '/api/integrations/billing/disconnect',
      syncUrl: '/api/integrations/billing/sync',
    },
    {
      id: 'paddle',
      name: 'Paddle',
    ...
    },
    {
      ...
      color: 'bg-yellow-500',
      configUrl: '/integrations/webhooks',
      disconnectUrl: '/api/integrations/webhooks/disconnect',
      syncUrl: '/api/integrations/webhooks/sync',
    },
  ]);
